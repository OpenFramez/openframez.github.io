...
برای مشارکت (کد یا محتوا)، [CLA.md](./CLA.md) را مطالعه کنید. با ارسال اولین مشارکت، CLA به‌صورت خودکار پذیرفته می‌شود.

## لایسنس‌های third-party

| Dependency | لایسنس | کاربرد |
|------------|--------|--------|
| Vazirmatn font | OFL | فونت فارسی |
| Wikimedia Commons API | CC0 | منبع عکس و ویدیو |
| Internet Archive | Public Domain | منبع ویدیوهای قدیمی |
| GitHub REST API | GitHub ToS | زیرساخت آپلود فدراتیو |
